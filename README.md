...
* **Homepage**: Hero con bio, panoramica dei progetti in evidenza, competenze e testimonianze.
* **Curriculum Vitae**: CV semantico in formato HTML con opzione di download in PDF.
...
* **Sass (SCSS)** per la gestione modulare degli stili
* **Bootstrap 5** (griglia e componenti base)
